    <nav class="navbar bg-body-tertiary fixed-top navbar-expand-lg scroll " id="parent">
        <div class="container-fluid">
            <div class="navLogo d-flex">
                <button class="navbar-toggler me-sm-2" type="button" data-bs-toggle="offcanvas"
        ...
        <div class="navbar-right d-flex align-items-center justify-content-end">
            <form class="d-flex formSearch" role="search">
                ...
                <form class="d-flex formSearch" role="search">
                    <input class="form-control py-2 px-5 " size="25" type="search" placeholder="Search"
                ...
                <div class="info">
                    <a href="" data-toggle="modal" data-target=".my-modal"
                        class="btn-login btn btn-success mx-2">Login</a>
                </div>
